...
function Sidebar({
  ...
  data-side={side}
  className={cn(
    "relative z-10 hidden h-full w-(--sidebar-width) shrink-0 transition-[width,margin] duration-200 ease-linear md:flex",
    "group-data-[collapsible=offcanvas]:w-0",
    "group-data-[side=left]:group-data-[collapsible=offcanvas]:-ml-(--sidebar-width)",
    "group-data-[side=right]:group-data-[collapsible=offcanvas]:-mr-(--sidebar-width)",
